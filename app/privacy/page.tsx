    ...
    >
      <section>
        ...
        <p>
          ...
          <strong>Michael Moretti</strong>, con sede in Via Garda 24, 63821
          Porto Sant&apos;Elpidio (FM), C.F. MRTMHL90L02G478E. Contatti:{" "}
      ...
      <section>
        ...
        <ul>
          <li>
            <strong>Dati di contatto.</strong> Nome, email, eventuale numero di
            telefono e contenuto del messaggio, quando ci scrivi via email o
            tramite form di contatto.
          </li>
          <li>
            <strong>Conversazioni con l&apos;assistente AI.</strong> Il testo
            che scrivi nel chatbot del sito, usato solo per generare la
            risposta. Ti invitiamo a non inserire dati personali sensibili o
            riservati nella chat.
          </li>
          <li>
          ...
          <li>
            ...
            password (hashata), ruolo, preferenze. Conservati solo se attivi un
            account su <code>/accesso</code>.
          </li>
        </ul>
      </section>
      ...
      <section>
        ...
        <ol>
          <li>
            ...
            preventivi, supporto. Base giuridica: esecuzione di misure
            precontrattuali (art. 6.1.b GDPR).
          </li>
          <li>
            <strong>Erogare il servizio</strong> dell'area clienti, dove
            presente. Base giuridica: contratto.
          </li>
          <li>
          ...
          <li>
            ...
            antiriciclaggio, conservazione documenti). Base giuridica: obbligo
            legale (art. 6.1.c).
          </li>
        </ol>
      </section>
      ...
      <section>
        ...
        <p>
          I dati possono essere comunicati a fornitori tecnici che agiscono come
          responsabili del trattamento (art. 28 GDPR):
        </p>
        <ul>
          <li>
            Fornitori di hosting e infrastruttura cloud (UE/USA, con SCC dove
            applicabile).
          </li>
          <li>
            Assistente AI / chatbot: <strong>Anthropic PBC</strong> (modelli
            Claude), USA — con Clausole Contrattuali Standard. Riceve i messaggi
            che scrivi in chat, solo per generare la risposta.
          </li>
          <li>Consulenti contabili e legali, in adempimento di obblighi.</li>
        </ul>
        <p>
          Non vendiamo dati personali a terzi. Non li usiamo per profilazione
          automatizzata.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          Alcuni fornitori possono trattare dati negli Stati Uniti o in altri
          paesi terzi. In quei casi adottiamo Clausole Contrattuali Standard
          (SCC) approvate dalla Commissione europea e, dove richiesto, misure
          supplementari.
        </p>
      </section>
