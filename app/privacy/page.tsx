    ...
    >
      ...
      <section>
        ...
        <p>
          ...
          Contatti: <a href="mailto:ciao@wowspace.it">ciao@wowspace.it</a> — PEC <span className={legalStyles.placeholder}>&lt;pec@example.it&gt;</span>.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          Per esercitare i diritti scrivi a <a href="mailto:ciao@wowspace.it">ciao@wowspace.it</a>. Rispondiamo
          entro 30 giorni.
        </p>
      </section>
